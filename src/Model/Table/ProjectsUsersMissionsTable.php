...
use App\Model\Entity\ProjectsUsersMission;
use Cake\ORM\Query;
 ...
 * @license  http://www.gnu.org/licenses/gpl-3.0.en.html GPL v3
 * @link     https://github.com/MaisonLogicielLibre/site_mll
 * @property \Cake\ORM\Association\BelongsTo $ProjectsUsers
 * @property \Cake\ORM\Association\BelongsTo $Missions
 */
class ProjectsUsersMissionsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('projects_users_missions');
