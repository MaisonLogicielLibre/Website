            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <?= $this->Form->create($application, ['type' => 'post', 'url' => ['action' => 'accepted']]); ?>
                        <fieldset>
                            <?php if ($application->getMission()->getRemainingPlaces() === 1) : ?>
                                <div class="bs-callout bs-callout-danger">
                                    ...
                                    <p> <?= __(
                                        'If you want to add more candidates {0} {1} accepting this candidate',
                                        $this->Html->link(
                            ...
                            <?php endif; ?>
                            <p><?= __(
                                'You\'re about to accept the application of {0} for the mission {1}',
                                $this->Html->link(
