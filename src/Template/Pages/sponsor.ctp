<div class="temp-text">
    <h1> <?= __('Become a sponsor at  Maison du Logiciel Libre!') ?> </h1>
	...
	<p> <?= __('Sponsors are displayed prominently on our website and on a large display screen on the main floor of École de Technologie Supérieure (ETS). Additional branding opportunities are available at ETS  and across our university network of UQÀM, McGill, Polytechnique,  Université de Montréal, Concordia, and Université de Sherbrooke') ?> </p><br>
