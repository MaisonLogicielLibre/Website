...
class MissionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type_mission' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'mentor_id' => 1,
            'type_mission' => 1,
            'created' => '2015-10-16 13:02:50',
            'modified' => '2015-10-16 13:02:50'
        ],
    ];
}
